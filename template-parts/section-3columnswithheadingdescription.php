...
<?php 
  ...
  $columnContentTwo = get_sub_field('column_content_second'); 
?>

<section class="container three-column p-0">
  <!-- heading -->
  <?php if( !empty($title)): ?>
  <h2 class="h2-heading m-auto mw-386 mb-24" style="font-size:48px">
    <?php echo $title; ?>
  </h2>
  <?php endif; ?>
  ...
  <div class="grid-no-gap grid--3-cols no-flex-gap mb-0">
    ...
    <div class="col-goals padding-32 border-bottom">
